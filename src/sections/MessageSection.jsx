...
const MessageSection = () => {
  useGSAP(() => {
    // ensure ScrollTrigger and SplitText plugins are registered with gsap
    ...
    // Animate words from below into their natural position
    paragraphTl.fromTo(
      paragraphSplit.words,
      { yPercent: 300, rotate: 3, opacity: 0 },
      {
        yPercent: 0,
        rotate: 0,
        ease: "power1.inOut",
        ...
        <div className="w-full h-full">
          ...
          <div className="flex-center md:mt-20 mt-10">
            <div className="max-w-md px-10 flex-center">
              <p className="paragraph-line text-center">
